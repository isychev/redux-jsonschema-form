...
function DefaultArrayItem(props) {
  ...
  return (
    <div key={props.index} className={props.className}>
      <div
        className={props.hasToolbar ? 'col-lg-11 col-md-9 col-sm-8' : 'col-12'}
      >
        {props.children}
      </div>

      {props.hasToolbar && (
        <div className="col-lg-1 col-md-3 col-sm-4 array-item-toolbox">
          <div
            className="btn-group"
...
function AddButton({ onClick, disabled }) {
  return (
    <div className="row">
      <p className="col-12 array-item-add text-left">
        <IconBtn
          type="info"
          icon="plus"
